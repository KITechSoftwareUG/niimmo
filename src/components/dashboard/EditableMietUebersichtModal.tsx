              ...
              <Table className="relative">
                <TableHeader className="sticky top-0 bg-white z-10 shadow-sm">
                  <TableRow className="border-b-2">
                    <TableHead className="w-[50px] font-semibold text-center sticky top-0 bg-white z-10">#</TableHead>
                    <TableHead className="w-[80px] font-semibold sticky top-0 bg-white z-10">Einheit</TableHead>
                    <TableHead className="w-[70px] font-semibold sticky top-0 bg-white z-10">Etage</TableHead>
                    <TableHead className="w-[60px] font-semibold sticky top-0 bg-white z-10">Qm</TableHead>
                    <TableHead className="w-[80px] font-semibold sticky top-0 bg-white z-10">Nutzung</TableHead>
                    <TableHead className="w-[80px] font-semibold sticky top-0 bg-white z-10">Status</TableHead>
                    <TableHead className="w-[120px] font-semibold sticky top-0 bg-white z-10">Vorname</TableHead>
                    <TableHead className="w-[120px] font-semibold sticky top-0 bg-white z-10">Nachname</TableHead>
                    <TableHead className="w-[160px] font-semibold sticky top-0 bg-white z-10">E-Mail</TableHead>
                    <TableHead className="w-[100px] font-semibold sticky top-0 bg-white z-10">Telefon</TableHead>
                    <TableHead className="w-[90px] font-semibold text-right sticky top-0 bg-white z-10">Kaltmiete</TableHead>
                    <TableHead className="w-[90px] font-semibold text-right sticky top-0 bg-white z-10">NK</TableHead>
                    <TableHead className="w-[90px] font-semibold text-right sticky top-0 bg-white z-10">Warmmiete</TableHead>
                    <TableHead className="w-[100px] font-semibold sticky top-0 bg-white z-10">Mietbeginn</TableHead>
                    <TableHead className="w-[100px] font-semibold sticky top-0 bg-white z-10">Mietende</TableHead>
                    <TableHead className="w-[90px] font-semibold text-right sticky top-0 bg-white z-10">Kaution Soll</TableHead>
                    <TableHead className="w-[90px] font-semibold text-right sticky top-0 bg-white z-10">Kaution Ist</TableHead>
                    <TableHead className="w-[80px] font-semibold sticky top-0 bg-white z-10">Lastschrift</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
